...
const AdminUser = () => {
  ...
  useEffect(() => {
    const getUserData = async () => {
        try {
            const res = await axios.get(`${BASE_URL}/jwt/profile`, {headers: {withCredentials: true, 
  ...
  const searchUser = async (e, searchId) => {
    e.preventDefault();
    try {
        const searchuser = await axios.get(`${BASE_URL}/jwt/profile/${searchId}`, {headers: {withCredentials: true}});
  ...
  const deleteUser = async (userId) => {    
    try {
        await axios.delete(`${BASE_URL}/jwt/delete/${userId}`, {headers: {withCredentials: true}});
