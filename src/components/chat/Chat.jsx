...
const Chat = () => {
  ...
  useEffect(() => {
    async function getImage() {
      try {
        setUserId(_id);
        const res = await axios.get(`${BASE_URL}/upload/avatar/${userId}`, {headers: {withCredentials: true}});
  ...
  useEffect(() => {
    const getConversationId = async () => {
      try {
        const res = await axios.get(`${BASE_URL}/conversation/${phone}`,  {headers: {withCredentials: true}});
  ...
  async function sendMessage(e) {
    ...
    try {
      if (files) {
          ...
          const res = await axios.post(`${BASE_URL}/message`, formData, {headers: {withCredentials: true}} );
          //console.log(res.data);
        }
        else {
          console.log("MESSAGE: ", message);
          const savedMessage = await axios.post(`${BASE_URL}/message`, 
