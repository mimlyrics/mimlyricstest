...
const EditorVideo = () => {
  ...
  const [Hi, setHi] = useState("");
    ...
    useEffect(() => {
        const getLyricsVideo = async () => {
            try {
                const lyrics = await axios.get(`${BASE_URL}/upload/video/${category}`, {headers: {withCredentials: true}});
                console.log(lyrics);
  ...
  const deleteVideo = async (videoId) => {
    try {
      await axios.delete(`${BASE_URL}/upload/video/${videoId}`, {headers: {withCredentials: true}});
