...
const VideoStream = () => {
  ...
  useEffect (() => {
    const getImage = async () => {
      try {
        const res = await axios.get(`${BASE_URL}/upload/avatar/${_id}`, {headers: {withCredentials: true}});
  ...
  useEffect(() => {
    const getVideoById = async () => {
        try {
            const res = await axios.get(`${BASE_URL}/upload/video/get/${id}`, {headers: {withCredentials: true}});
  ...
  useEffect(() => {
    const videoViews = async () => {
      try{
        const res = await axios.put(`${BASE_URL}/video/views/${id}`, {headers: {"Content-Type": "application/json", withCredentials: true}});
        console.log(res.data);
      }catch(err) {
        setErrMsg(err?.data?.message);
      }
  ...
  const downloadVideo = async (e) => {
    ...
    console.log("Heyy");
    try {
        const res = await axios.get(`${BASE_URL}/video/download/${id}`, {headers: {withCredentials: true}});
        console.log(res.data);
    }catch(err) {
        setErrMsg(err?.data?.message);
    }
  ...
  const commentVideo = async (e) => {
    e.preventDefault();
    try {
      const res = await axios.post(`${BASE_URL}/video/comment`, {mediaId: id, userId: _id, text: text, username: firstName, userprofile: image, type: 'video'}, {headers: {withCredentials: true}});
      console.log(res.data);
    }catch(err) {
      setErrMsg(err?.data?.message);
    }
  ...
  useEffect(() => {
    const getComments = async () => {
      try {
        const res = await axios.get(`${BASE_URL}/video/comment/${id}`, {headers: {withCredentials: true}});
  ...
  const answerComment = async (e,commentId) => {
    e.preventDefault();
    try {
      const res = await axios.put(`${BASE_URL}/video/comment/response/${commentId}`, 
  ...
  const likeFunction = async (e) => {
    e.preventDefault();
    try {
      const res = await axios.put(`${BASE_URL}/video/like/${id}`, {userId: _id}, { headers: {"Content-Type": "application/json"}});
      console.log(res.data);
  ...
  const likeCommentFunction = async (e, commentId) => {
    ...
    console.log("Yess");
    try {
      const res = await axios.put(`${BASE_URL}/video/comment/like/${commentId}`, {userId: _id}, { headers: {"Content-Type": "application/json"}});
      console.log(res.data);
  ...
  const likeResponseCommentFunction = async (e, commentId) => {
    e.preventDefault();
    try {
      const res = await axios.put(`${BASE_URL}/video/comment/like/response/${commentId}`, {userId: _id}, { headers: {"Content-Type": "application/json"}});
      console.log(res.data);
  ...
  const SearchVideo = async (e, searchId) => {
    console.log("olllk");
    try {
      const res = await axios.get(`${BASE_URL}/upload/video/search/${searchId}`,  {headers: {withCredentials: true}});
